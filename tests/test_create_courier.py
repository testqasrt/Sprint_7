...
class TestCreateCourier:
    ...
    @pytest.mark.parametrize("data", ("user_data", "user_data_without_firstName"))
    def test_create_courier_success(self, request, client, data, delete_courier_list):
        data = request.getfixturevalue(data)
        delete_courier_list.append(data)
    ...
    def test_create_duplicate_courier(self, client, user_data, delete_courier_list):
        delete_courier_list.append(user_data)
